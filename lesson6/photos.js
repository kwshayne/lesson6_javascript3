...
function previewFive() {
   ...
   document.getElementsByTageName("img")[0].src = "images/IMG_0" + photoOrder[0] + "sm.jpg";
   document.getElementsByTageName("img")[4].src = "images/IMG_0" + photoOrder[4] + "sm.jpg";
...
function createEventListeners() {
   ...
   //declare variable for document element with id of rightarrow in the htlm document
